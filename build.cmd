...
REM Auto-detect Visual Studio version instead of hardcoding
cmake -A x64 ..
...
REM //---------- SKIPPED: High PolyCount SUV Car Model (not needed for drone sim) ----------
ECHO Skipping car asset download (not needed for drone simulation)
